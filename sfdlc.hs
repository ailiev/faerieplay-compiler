...
-- for C:
import SFDL_C.Abs               -- the abstract syntax types from BNFC
import SFDL_C.Lex               -- Alex lexer
import SFDL_C.Par               -- the Happy parser 
import SFDL_C.Print             -- generated by BNFC, to print an AST
import SFDL_C.ErrM

import SFDL_C_Fixup                     (fixupProg)
    ...
    in case ast of
         ...
         Ok  prog@(Prog _ _) ->
           do logmsg INFO "Parse Successful!"
              ...
              case typeCheck (fixupProg prog) of
