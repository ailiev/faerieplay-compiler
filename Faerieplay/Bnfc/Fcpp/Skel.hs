module Faerieplay.Bnfc.Fcpp.Skel where
...
transDec x = case x of
  ...
  TypeDecl_C typ id  -> failure x
  ArrVarDecl typ id exp  -> failure x
...
transStm x = case x of
  ...
  SAssC assstm  -> failure x
  SReturn exp  -> failure x
  SPrint str exps  -> failure x
  SFor_C id exp0 exp assstm stm  -> failure x
...
transAssStm :: AssStm -> Result
transAssStm x = case x of
  ASOpAss lval assop exp  -> failure x
  ASPostFix lval postfixop  -> failure x
  ASPreFix postfixop lval  -> failure x
...
transPostFixOp :: PostFixOp -> Result
transPostFixOp x = case x of
  PFIncr  -> failure x
  PFDecr  -> failure x
...
transConstExp :: ConstExp -> Result
transConstExp x = case x of
  ConstExp exp  -> failure x
